...
<head>
    <jsp:include page="partials/head.jsp">
        <jsp:param name="title" value="Burger 'R Us"/>
    </jsp:include>
</head>
<body>
    <div class="container">
        ...
        <%-- Let's take a look at some implicit objects,
        available to us with JSP --%>
...
<%-- Now let's run some arbitrary Java code, to increment the counter by 1 every
